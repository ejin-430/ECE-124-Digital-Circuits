...
-- Equation(s):
-- \INST4|Mux3~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[4]~input_o\ $ (\sw[0]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[4]~input_o\) # (\sw[0]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[4]~input_o\ & 
-- \sw[0]~input_o\))))
...
-- Equation(s):
-- \INST4|Mux2~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[5]~input_o\ $ (\sw[1]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[5]~input_o\) # (\sw[1]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[5]~input_o\ & 
-- \sw[1]~input_o\))))
...
-- Equation(s):
-- \INST4|Mux1~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[6]~input_o\ $ (\sw[2]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[6]~input_o\ & 
-- \sw[2]~input_o\))))
...
-- Equation(s):
-- \INST4|Mux0~0_combout\ = (\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[7]~input_o\ $ (\sw[3]~input_o\)))) # (!\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & ((\sw[7]~input_o\) # (\sw[3]~input_o\))) # (!\pb_n[0]~input_o\ & (\sw[7]~input_o\ & 
-- \sw[3]~input_o\))))
