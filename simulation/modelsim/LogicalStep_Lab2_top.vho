...
SIGNAL \INST5|logic_output[0]~0_combout\ : std_logic;
SIGNAL \sw[1]~input_o\ : std_logic;
SIGNAL \sw[5]~input_o\ : std_logic;
SIGNAL \INST3|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ : std_logic;
SIGNAL \sw[6]~input_o\ : std_logic;
SIGNAL \sw[2]~input_o\ : std_logic;
SIGNAL \INST5|logic_output[2]~2_combout\ : std_logic;
SIGNAL \sw[7]~input_o\ : std_logic;
SIGNAL \sw[3]~input_o\ : std_logic;
SIGNAL \INST3|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\ : std_logic;
SIGNAL \INST5|logic_output[3]~3_combout\ : std_logic;
SIGNAL \INST3|INST2|FULL_ADDER_SUM_OUTPUT~combout\ : std_logic;
SIGNAL \INST5|logic_output[1]~1_combout\ : std_logic;
SIGNAL \INST6|Mux5~0_combout\ : std_logic;
SIGNAL \INST4|logic_output[2]~3_combout\ : std_logic;
SIGNAL \INST4|logic_output[3]~4_combout\ : std_logic;
SIGNAL \INST4|logic_output[0]~0_combout\ : std_logic;
SIGNAL \INST4|logic_output[0]~1_combout\ : std_logic;
SIGNAL \INST4|logic_output[1]~2_combout\ : std_logic;
...
\INST5|logic_output[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_output[0]~0_combout\ = \sw[0]~input_o\ $ (((\sw[4]~input_o\ & !\pb_n[2]~input_o\)))
...
PORT MAP (
	...
	combout => \INST5|logic_output[0]~0_combout\);
...
-- Equation(s):
-- \INST3|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[0]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\)))
...
\INST5|logic_output[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_output[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\INST3|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ $ (\sw[6]~input_o\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST3|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \INST5|logic_output[2]~2_combout\);
...
-- Equation(s):
-- \INST3|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\INST3|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\INST3|INST2|FULL_ADDER_CARRY_OUTPUT~0_combout\ & (\sw[6]~input_o\ & \sw[2]~input_o\))
...
\INST5|logic_output[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_output[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\INST3|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\)))))
...
PORT MAP (
	...
	combout => \INST5|logic_output[3]~3_combout\);

-- Location: LCCOMB_X9_Y7_N22
\INST3|INST2|FULL_ADDER_SUM_OUTPUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST3|INST2|FULL_ADDER_SUM_OUTPUT~combout\ = \sw[1]~input_o\ $ (\sw[5]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
\INST5|logic_output[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST5|logic_output[1]~1_combout\ = (\pb_n[2]~input_o\ & ((\sw[1]~input_o\))) # (!\pb_n[2]~input_o\ & (\INST3|INST2|FULL_ADDER_SUM_OUTPUT~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST3|INST2|FULL_ADDER_SUM_OUTPUT~combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	combout => \INST5|logic_output[1]~1_combout\);

-- Location: LCCOMB_X11_Y7_N2
\INST6|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|Mux5~0_combout\ = (\INST5|logic_output[3]~3_combout\ & ((\INST5|logic_output[0]~0_combout\ & ((\INST5|logic_output[1]~1_combout\))) # (!\INST5|logic_output[0]~0_combout\ & (\INST5|logic_output[2]~2_combout\)))) # (!\INST5|logic_output[3]~3_combout\ 
-- & (\INST5|logic_output[2]~2_combout\ & (\INST5|logic_output[0]~0_combout\ $ (\INST5|logic_output[1]~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST5|logic_output[0]~0_combout\,
	datab => \INST5|logic_output[2]~2_combout\,
	datac => \INST5|logic_output[3]~3_combout\,
	datad => \INST5|logic_output[1]~1_combout\,
	combout => \INST6|Mux5~0_combout\);

-- Location: LCCOMB_X9_Y7_N8
\INST4|logic_output[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_output[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \INST4|logic_output[2]~3_combout\);

-- Location: LCCOMB_X9_Y7_N6
\INST4|logic_output[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_output[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[7]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \INST4|logic_output[3]~4_combout\);

-- Location: LCCOMB_X9_Y7_N2
\INST4|logic_output[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_output[0]~0_combout\ = (\sw[7]~input_o\ & ((\sw[3]~input_o\) # (\INST3|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\))) # (!\sw[7]~input_o\ & (\sw[3]~input_o\ & \INST3|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\))
...
PORT MAP (
	...
	datac => \sw[3]~input_o\,
	datad => \INST3|INST3|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	combout => \INST4|logic_output[0]~0_combout\);

-- Location: LCCOMB_X9_Y7_N16
\INST4|logic_output[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_output[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\INST4|logic_output[0]~0_combout\)))
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datac => \sw[4]~input_o\,
	datad => \INST4|logic_output[0]~0_combout\,
	combout => \INST4|logic_output[0]~1_combout\);

-- Location: LCCOMB_X9_Y7_N14
\INST4|logic_output[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST4|logic_output[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \INST4|logic_output[1]~2_combout\);

-- Location: LCCOMB_X10_Y7_N4
\INST7|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|Mux5~0_combout\ = (\INST4|logic_output[3]~4_combout\ & ((\INST4|logic_output[0]~1_combout\ & ((\INST4|logic_output[1]~2_combout\))) # (!\INST4|logic_output[0]~1_combout\ & (\INST4|logic_output[2]~3_combout\)))) # (!\INST4|logic_output[3]~4_combout\ 
-- & (\INST4|logic_output[2]~3_combout\ & (\INST4|logic_output[0]~1_combout\ $ (\INST4|logic_output[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST4|logic_output[2]~3_combout\,
	datab => \INST4|logic_output[3]~4_combout\,
	datac => \INST4|logic_output[0]~1_combout\,
	datad => \INST4|logic_output[1]~2_combout\,
...
-- Equation(s):
-- \INST6|Mux1~0_combout\ = (\INST5|logic_output[2]~2_combout\ & ((\INST5|logic_output[1]~1_combout\ & (\INST5|logic_output[0]~0_combout\ & !\INST5|logic_output[3]~3_combout\)) # (!\INST5|logic_output[1]~1_combout\ & ((\INST5|logic_output[3]~3_combout\))))) 
-- # (!\INST5|logic_output[2]~2_combout\ & (!\INST5|logic_output[3]~3_combout\ & ((\INST5|logic_output[0]~0_combout\) # (\INST5|logic_output[1]~1_combout\))))
...
PORT MAP (
	dataa => \INST5|logic_output[0]~0_combout\,
	datab => \INST5|logic_output[2]~2_combout\,
	datac => \INST5|logic_output[1]~1_combout\,
	datad => \INST5|logic_output[3]~3_combout\,
	combout => \INST6|Mux1~0_combout\);

-- Location: LCCOMB_X10_Y7_N30
\INST7|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|Mux1~0_combout\ = (\INST4|logic_output[2]~3_combout\ & ((\INST4|logic_output[3]~4_combout\ & ((!\INST4|logic_output[1]~2_combout\))) # (!\INST4|logic_output[3]~4_combout\ & (\INST4|logic_output[0]~1_combout\ & \INST4|logic_output[1]~2_combout\)))) 
-- # (!\INST4|logic_output[2]~3_combout\ & (!\INST4|logic_output[3]~4_combout\ & ((\INST4|logic_output[0]~1_combout\) # (\INST4|logic_output[1]~2_combout\))))
...
-- Equation(s):
-- \INST6|Mux0~0_combout\ = (\INST5|logic_output[3]~3_combout\) # ((\INST5|logic_output[2]~2_combout\ & ((!\INST5|logic_output[1]~1_combout\) # (!\INST5|logic_output[0]~0_combout\))) # (!\INST5|logic_output[2]~2_combout\ & 
-- ((\INST5|logic_output[1]~1_combout\))))
...
-- Equation(s):
-- \INST7|Mux0~0_combout\ = (\INST4|logic_output[3]~4_combout\) # ((\INST4|logic_output[2]~3_combout\ & ((!\INST4|logic_output[1]~2_combout\) # (!\INST4|logic_output[0]~1_combout\))) # (!\INST4|logic_output[2]~3_combout\ & 
-- ((\INST4|logic_output[1]~2_combout\))))
...
-- Equation(s):
-- \INST6|Mux6~0_combout\ = (\INST5|logic_output[2]~2_combout\ & (!\INST5|logic_output[1]~1_combout\ & ((\INST5|logic_output[3]~3_combout\) # (!\INST5|logic_output[0]~0_combout\)))) # (!\INST5|logic_output[2]~2_combout\ & (\INST5|logic_output[0]~0_combout\ & 
-- (\INST5|logic_output[1]~1_combout\ $ (!\INST5|logic_output[3]~3_combout\))))
...
-- Equation(s):
-- \INST7|Mux6~0_combout\ = (\INST4|logic_output[2]~3_combout\ & (!\INST4|logic_output[1]~2_combout\ & ((\INST4|logic_output[3]~4_combout\) # (!\INST4|logic_output[0]~1_combout\)))) # (!\INST4|logic_output[2]~3_combout\ & (\INST4|logic_output[0]~1_combout\ & 
-- (\INST4|logic_output[3]~4_combout\ $ (!\INST4|logic_output[1]~2_combout\))))
...
-- Equation(s):
-- \INST6|Mux4~0_combout\ = (\INST5|logic_output[2]~2_combout\ & (\INST5|logic_output[3]~3_combout\ & ((\INST5|logic_output[1]~1_combout\) # (!\INST5|logic_output[0]~0_combout\)))) # (!\INST5|logic_output[2]~2_combout\ & (!\INST5|logic_output[0]~0_combout\ & 
-- (\INST5|logic_output[1]~1_combout\ & !\INST5|logic_output[3]~3_combout\)))
...
-- Equation(s):
-- \INST7|Mux4~0_combout\ = (\INST4|logic_output[2]~3_combout\ & (\INST4|logic_output[3]~4_combout\ & ((\INST4|logic_output[1]~2_combout\) # (!\INST4|logic_output[0]~1_combout\)))) # (!\INST4|logic_output[2]~3_combout\ & (!\INST4|logic_output[3]~4_combout\ & 
-- (!\INST4|logic_output[0]~1_combout\ & \INST4|logic_output[1]~2_combout\)))
...
-- Equation(s):
-- \INST7|Mux3~0_combout\ = (\INST4|logic_output[1]~2_combout\ & ((\INST4|logic_output[2]~3_combout\ & ((\INST4|logic_output[0]~1_combout\))) # (!\INST4|logic_output[2]~3_combout\ & (\INST4|logic_output[3]~4_combout\ & !\INST4|logic_output[0]~1_combout\)))) 
-- # (!\INST4|logic_output[1]~2_combout\ & (!\INST4|logic_output[3]~4_combout\ & (\INST4|logic_output[2]~3_combout\ $ (\INST4|logic_output[0]~1_combout\))))
...
-- Equation(s):
-- \INST6|Mux3~0_combout\ = (\INST5|logic_output[1]~1_combout\ & ((\INST5|logic_output[0]~0_combout\ & (\INST5|logic_output[2]~2_combout\)) # (!\INST5|logic_output[0]~0_combout\ & (!\INST5|logic_output[2]~2_combout\ & \INST5|logic_output[3]~3_combout\)))) # 
-- (!\INST5|logic_output[1]~1_combout\ & (!\INST5|logic_output[3]~3_combout\ & (\INST5|logic_output[0]~0_combout\ $ (\INST5|logic_output[2]~2_combout\))))
...
-- Equation(s):
-- \INST7|Mux2~0_combout\ = (\INST4|logic_output[1]~2_combout\ & (((!\INST4|logic_output[3]~4_combout\ & \INST4|logic_output[0]~1_combout\)))) # (!\INST4|logic_output[1]~2_combout\ & ((\INST4|logic_output[2]~3_combout\ & (!\INST4|logic_output[3]~4_combout\)) 
-- # (!\INST4|logic_output[2]~3_combout\ & ((\INST4|logic_output[0]~1_combout\)))))
...
-- Equation(s):
-- \INST6|Mux2~0_combout\ = (\INST5|logic_output[1]~1_combout\ & (\INST5|logic_output[0]~0_combout\ & ((!\INST5|logic_output[3]~3_combout\)))) # (!\INST5|logic_output[1]~1_combout\ & ((\INST5|logic_output[2]~2_combout\ & 
-- ((!\INST5|logic_output[3]~3_combout\))) # (!\INST5|logic_output[2]~2_combout\ & (\INST5|logic_output[0]~0_combout\))))
